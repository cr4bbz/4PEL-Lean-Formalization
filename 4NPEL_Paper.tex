...
\begin{enumerate}
    ...
    \item I demonstrate that mapping non-bivalent validity standards (ST, LP, SS) onto this probabilistic space successfully models and defuses five classical epistemic paradoxes (Liar, Lottery, Preface, Moore's Paradox, and G\"odel-inspired epistemic fixed points) alongside the threat of Epistemic Explosion.
...
\begin{itemize}
    \item \textbf{Class I (Self-Reference):} Paradoxes like the Liar and the G\"odel-inspired fixed points forcefully absorb the system into a stable \textbf{Epistemic Glut} ($B$).
...
Furthermore, by applying these non-bivalent validities to probabilistic belief operators, 4-PEL provides a robust mechanism to evaluate and defuse five classical epistemic paradoxes, alongside the structural threat of epistemic explosion. The framework also demonstrates multi-agent rational disagreement. The seamless transition of classical contradictions into rational epistemic gaps or bounded gluts showcases the framework's expressive power. 
