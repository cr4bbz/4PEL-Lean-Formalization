...
\date{Working manuscript, version 0.5, 8 September 2026}
...
At the coarsest evidence level, the bilateral positive/negative signature also induces a two-class matroid closure: same-polarity atoms are parallel, closure preserves the four-valued state, and the channel ranks of \(\Nval,\Tval,\Fval,\Bval\) are respectively \(0,1,1,2\). This is a structural theorem about the 4-PEL projection, not a claim that arbitrary epistemic evidence is matroidal.
