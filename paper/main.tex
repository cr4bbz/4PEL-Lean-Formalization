...
\date{Working manuscript, version 0.13, 9 September 2026}
...
\input{sections/19_lockean_threshold_phase_transition}
\input{sections/20_cpel_split_translation_collapse}
\input{sections/21_recovery_consequence_transfer}
