...
This distinction now has a model-level foothold. For weight-generated strong
model paths and probability-free modal formulas, the two formula-support
masses are verified affine functions. Sequential diagonal changes in this
fragment can therefore be connected directly to genuine intermediate strong
models; the single packaged theorem performing that composition remains the
next formal gate. Simultaneous changes remain the boundary-coincident case.
