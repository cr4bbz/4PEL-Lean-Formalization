...
The complex notation introduced in Section~\ref{sec:complex-coordinates} is a
coordinate presentation of the existing bilateral square. It does not invoke
complex probability amplitudes and should not be read as a quantum-logical
claim. A literature comparison with algebraic and geometric presentations of
bilattices remains part of the publication-critical audit.
...
One substantial formula fragment and its complete affine crossing
classification are now settled, while two stronger realization questions
remain open.
...
Lean verifies the complete probability-free fragment, including arbitrary
nesting of negation, conjunction, primitive knowledge, and raw possibility.
For this fragment the crossing times and sequential midpoint phases are now
realized by complete strong models, and the simultaneous point is exactly the
glut value at \((c,c)\). The open part is to characterize the maximal
path-invariant fragment that may also contain selected occurrences of
