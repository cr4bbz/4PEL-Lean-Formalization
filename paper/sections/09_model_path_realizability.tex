...
vary with \(t\). The next formal step is to package the verified affine
probability-free support pair into the complex coordinate and lift the crossing
and intermediate-phase theorems directly to the strong model path.
