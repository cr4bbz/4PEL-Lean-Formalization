...
The active branch was built successfully with Lean 4.31 after the final fixes to \texttt{ModalDynamicsIntermediatePhase.lean}. The manuscript therefore treats the claims listed above as machine-checked at the formal level represented by their exact theorem statements.
